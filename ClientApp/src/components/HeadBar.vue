      ...
      <v-col cols="12" class="pa-0 d-flex align-center">
        ...
        <ValidationObserver>
          <ValidationProvider v-slot="{ errors }" name="Project name" rules="required">
            <v-text-field v-model="activeProjectName" name="nameSpace" placeholder="Name your project" type="text" :error-messages="errors" required @input="changeName"></v-text-field>
          </ValidationProvider>
        </ValidationObserver>
